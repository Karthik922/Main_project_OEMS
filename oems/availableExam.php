	...
	<div id="container">
		...
		<div id="wrapper">
			...
			<table border="1px" class="">
						<tr>
							<th>S.No&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
							<th>Exam Title&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
							<th>Exam Time Limit&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
							<th>Display Limit&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
							<th>Discription </th>
							<th>Total Count</th>
...
$(document).ready(function(){
		...
		$("#course").change(function(){
						cid=$(this).val();
						//alert(cid);
						$.post("avlexam.php",{id:cid},function(data){
							$("#viewTable").html(data);
						});
