	...
	<div id="container">
		...
		<?php
						if(isset($_POST["submit"]))
						{
							...
							$sq="INSERT INTO `partaquestions` (`QIDA`, `CU_ID`, `EXTITLE_ID`, `QUESTIONS`, `OP1`, `OP2`, `OP3`, `OP4`, `OP5`, `CORRECT_ANSWER`,`QTYPE`) VALUES (NULL, '{$_POST["cla"]}', '{$_POST["etle"]}', '{$_POST["examDesc"]}', '{$_POST["choice1"]}', '{$_POST["choice2"]}', '{$_POST["choice3"]}', '{$_POST["choice4"]}', '{$_POST["choice5"]}', '{$_POST["correct_choice"]}','{$_POST["radio"]}')";
							if($db->query($sq))
							{
			...
			<div id="boxx">
				<form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
					...
					<textarea name="examDesc" class="form-control" rows="4" placeholder="Type Question here...." required=""></textarea>
