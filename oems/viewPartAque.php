		...
		<div id="wrapper">
			...
			<div id="boxx">
				<form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
					<br>
					<h4 align="center"> View Part A Questions</h4>
					<h3> </h3><br>
					<?php
						if(isset($_GET["mes"]))
						{
	...
	$("#ad4").fadeOut();
		...
		$("#course").change(function(){
				...
				$("#state").click(function(){
						...
						//alert(cuid);
						//alert(eid);
						$.post("viewQue.php",{id:cuid,ie:eid},function(data){
							$("#viewTable").html(data);
						});
		...
		<div id="tblbox">	<table border="1px" class="">
						<tr>
							<th>S.No</th>
							<th>Questions&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
							<th>Option1&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
							<th>Option2&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
							<th>Option3&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
							<th>Option4&nbsp&nbsp&nbsp&nbsp&nbsp</th>
							<th>Option5&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
							<th>Correct Answer&nbsp&nbsp&nbsp&nbsp</th>
