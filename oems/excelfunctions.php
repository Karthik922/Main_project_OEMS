              ...
              while (($getData = fgetcsv($file, 10000, ",")) !== FALSE)
               {
				  ...
				  // {
					   $sq="INSERT INTO `partaquestions` (`QIDA`, `CU_ID`, `EXTITLE_ID`, `QUESTIONS`, `OP1`, `OP2`, `OP3`, `OP4`, `OP5`, `CORRECT_ANSWER`,`QTYPE`) VALUES (NULL, '{$_POST["cla"]}', '{$_POST["etle"]}', '{$getData[0]}', '{$getData[1]}', '{$getData[2]}', '{$getData[3]}', '{$getData[4]}', '{$getData[5]}', '{$getData[6]}','{$getData[7]}')";
